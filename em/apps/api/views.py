...
class AdSearchView(ListAPIView):
    ...
    def get_queryset(self):
        ...
        return Ad.objects.filter(filters).order_by('id')
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            if ad_receiver.user == request.user:
                return Response({"detail": "Нельзя создать предложение обмена между своими же объявлениями"}, 
...
class ExchangeProposalUpdateStatusView(GenericAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(ProposalSerializer(updated_proposal).data)
